...
#    print ("       -d <level>      Set debug level, for example 10, 20, 100.")
    ...
    print ("       -retry <MINUTES>                How many minutes to wait before trying again when there are problems contacting the server.")
    print ("                                       If not specified, " + str(delayMinutes) + " minutes.")
